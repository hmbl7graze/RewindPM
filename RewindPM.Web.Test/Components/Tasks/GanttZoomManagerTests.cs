...
public class GanttZoomManagerTests
{
    ...
    [InlineData(15.0, 2, 3, false)] // セル幅15px、3日おき、dayIndex=2は非表示
    [InlineData(15.0, 3, 4, true)]  // セル幅15px、3日おき、dayIndex=3は表示
    [InlineData(9.0, 2, 3, false)]  // セル幅9px、3日おき、dayIndex=2は非表示
    [InlineData(9.0, 3, 4, true)]   // セル幅9px、3日おき、dayIndex=3は表示
